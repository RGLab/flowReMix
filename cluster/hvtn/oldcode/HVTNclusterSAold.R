...
file <- paste("results/hvtn_5_niter", niter, "npost", npost, "seed", seed, "SAold.rds", sep = "")
saveRDS(object = fit, file = file)

file <- paste("results/hvtn_stab_5_niter", niter, "npost", npost, "seed", seed, "SAold.Robj", sep = "")
